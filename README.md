...
The `0.0.27` public pre-release builds from a fresh clone: Swift packages resolve
`https://github.com/SwiftTUI/swift-tui.git` and (for the native SwiftUI host)
`https://github.com/SwiftTUI/swift-tui-swiftui.git` at tag `0.0.27`, and
WebExample uses the `swift-tui-web` `0.0.27` GitHub release tarballs for
